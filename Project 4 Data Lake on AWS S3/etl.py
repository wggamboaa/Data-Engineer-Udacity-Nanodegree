...
def create_spark_session():
    ...
    Description: Create the spark session for data processing
    """
    spark = SparkSession \
        .builder \
...
def process_song_data(spark, input_data, output_data):
    ...
    Description: Read the song data and create the extracted song tables and artist table data
    Parameters:
    1. spark: Set the spark session.
    2. input_data: Input file path of the data to read.
    3. output_data: output file path of the data to read.
    """
...
def process_log_data(spark, input_data, output_data):
    ...
    Description: It is responsible for performing the ETL of the event file to extract the data from the time tables, users and songplays from it.
    Parameters:
    1. spark: Set the spark session.
    2. input_data: Input file path of the data to read.
    3. output_data: output file path of the data to read.
...
def main():
    ...
    """
    Function: main
    Description: Read the data of the songs and events from the S3 repository to perform an ETL on other new tables and then load them in another S3 directory in a parquet format.
    """

    spark = create_spark_session()
    input_data = " s3://udacity-dend/"
    output_data = "s3://sparky-project-dend/"
