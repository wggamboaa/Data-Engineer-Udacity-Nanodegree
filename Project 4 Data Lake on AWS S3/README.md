...
1. Configure our AWS credentials in the dl.cfg file

2. Create an output repository called "sparky-project-dend"

3. Execute the python file as follows "python etl.py".
